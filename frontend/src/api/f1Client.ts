...
export const fetchRaceControl = (sessionId: number): Promise<RaceControlMessage[]> =>
  api.get<RaceControlMessage[]>('/race-control', { params: { session_id: sessionId } }).then(r => r.data)
